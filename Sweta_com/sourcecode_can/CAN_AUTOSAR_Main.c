 ...
 * Author: ma70436
 *
 * Created on October 18, 2022, 11:34 AM
 */
...
//    COM_SIG_e_List SIG_List;
//    SIG_List = 1;
//    CAN_Send_signal(SIG_List,0x60);
    
    /* While loop*/
    for(;;){
        __delay_ms(500);
        CAN_FRAME(0,data);  /* Calling CAN FRAME API to send the data to PDUR */
        LED0 =~LED0;
    }
    return;
